...
CFG_JEMALLOC_CFLAGS_arm-unknown-linux-gnueabi := -D__arm__ $(CFLAGS) -march=armv6 -marm
CFG_GCCISH_CFLAGS_arm-unknown-linux-gnueabi := -Wall -g -fPIC -D__arm__ $(CFLAGS) -march=armv6 -marm
