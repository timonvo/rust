...
CFG_JEMALLOC_CFLAGS_arm-unknown-linux-musleabi := -mthumb -mcpu=cortex-a9 -march=armv7-a -Wall -Werror -ggdb3 -fPIC -D__arm__=1 -mfpu=vfp -funwind-tables -DJEMALLOC_C11ATOMICS=1 $(CFLAGS)
