# Targets ARMv6 with no hardware float support, using the soft float-abi and ARM
# code generation.
...
CFG_JEMALLOC_CFLAGS_arm-unknown-linux-musleabi := -Wall -g -fPIC -D__arm__ $(CFLAGS) -march=armv6 -marm -DJEMALLOC_C11ATOMICS=1
CFG_GCCISH_CFLAGS_arm-unknown-linux-musleabi := -Wall -g -fPIC -D__arm__ $(CFLAGS) -march=armv6 -marm
